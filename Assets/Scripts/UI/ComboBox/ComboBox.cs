...
public class ComboBox : MonoBehaviour
{
	...
	private Transform canvasTransform
	{
		get
		{
			...
			{
				_canvasTransform = this.transform;

//				while (_canvasTransform.gameObject.GetComponent<Canvas>() == null) {
//					Debug.Log (_canvasTransform);
//					_canvasTransform = _canvasTransform.root;
//				}
			}
