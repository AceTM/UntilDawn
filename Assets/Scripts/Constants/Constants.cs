public class Constants{
	...
	static public string EXAMPLE_CSV = "CSV/CSVExample10";
	...
	static public string MES_ID = "ID";
	...
	static public string MES_LEFT = "Left";

	// Message files
	static public string MF_A01 = "CSV/CSVExample10";
}
